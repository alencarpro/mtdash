...
const SingleDashboard = () => {
  ...
  const panelTitleColors = ["#93c5fd", "#93c5fd", "#93c5fd", "#93c5fd", "#2563eb", "#2563eb"];
  ...
  return (
    ...
    >
      ...
      <header className="flex-shrink-0 flex items-center justify-between px-3 sm:px-4 py-2 sm:py-3" style={{ borderBottom: '1px solid rgba(148,163,184,0.18)', background: 'rgba(10,17,30,0.78)' }}>
        ...
        <span className="text-[32px] sm:text-[36px] font-bold uppercase tracking-wider" style={{ color: panelTitleColors[active] }}>{panelTitles[active]}</span>
      </header>
      {/* Reload progress bar */}
