...
const menuItems = [
  { label: "01", icon: LayoutDashboard, path: "/dashboard/overview" },
  { label: "01", icon: TrendingUp, path: "/dashboard/economy" },
  { label: "02", icon: Users, path: "/dashboard/social" },
  { label: "03", icon: Leaf, path: "/dashboard/environment" },
];
